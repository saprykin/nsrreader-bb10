/* config-djvu.h.  Generated from config-djvu.h.in by configure.  */
/* config/config-djvu.h.in.  Generated from configure.ac by autoheader.  */


#ifndef CONFIG_DJVU_H
#define CONFIG_DJVU_H
/* config-djvu.h: begin */


/* directory "bindir" */
#define DIR_BINDIR "/usr/pkg/bin"

/* directory "datadir" */
#define DIR_DATADIR "/usr/pkg/share"

/* directory "exec_prefix" */
#define DIR_EXEC_PREFIX "/usr/pkg"

/* directory "libdir" */
#define DIR_LIBDIR "/usr/pkg/lib"

/* directory "mandir" */
#define DIR_MANDIR "/usr/pkg/share/man"

/* directory "prefix" */
#define DIR_PREFIX "/usr/pkg"
